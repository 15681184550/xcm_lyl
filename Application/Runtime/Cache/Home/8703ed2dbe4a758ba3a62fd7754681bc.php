...
<div class="weui-cells weui-cells_form" style="width: 90%;margin: 0 auto;border-radius: 5px;margin-bottom: 15px;">
    <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label" style="color: #5D5D5D">名称:</label></div>
        <div class="weui-cell__bd">
            <input class="weui-input" id="name" value="" type="text" placeholder="请输入您的名称">
        </div>
    </div>
</div>
<div class="weui-cells weui-cells_form" style="width: 90%;margin: 0 auto;border-radius: 5px;margin-bottom: 15px;">
