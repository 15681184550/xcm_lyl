...
<div id="tag1" style="display: none">
    <!--轮播开始-->
        <div class="swipe" id="mySwipe">
            <ul class="swipe-wrap">
                <li>
                    <img src="/Home/img/1.jpg" data-org="/Home/img/1.jpg" index-img="5" data-bn-ipg="top-rec-m-1-1" width="100%" height="300px"/>
                </li>
                <li>
                    <img src="/Home/img/bannerC.jpg" data-org="/Home/img/bannerC.jpg" index-img="5" data-bn-ipg="top-rec-m-1-1" width="100%" height="300px"/>
                </li>
                <li>
                    <img src="/Home/img/bannerWT.jpeg" data-org="/Home/img/bannerWT.jpeg" index-img="5" data-bn-ipg="top-rec-m-1-1" width="100%" height="300px"/>
                </li>
            </ul>
            <div class="mask">
                <ul id="mySwipePage" class="page"><li></li><li></li><li></li></ul>
            </div>
        </div>
    <!--轮播结束-->
    <!--热门开始-->
...
<!--轮播图的css-->
<script src="/Home/js/swipe.js"></script>
